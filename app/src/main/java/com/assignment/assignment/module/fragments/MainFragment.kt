...
import com.assignment.assignment.module.adapters.RecycleViewAdadpter
import com.assignment.assignment.module.fragments.viewmodels.MainViewModel
...
class MainFragment : Fragment() {
    ...
    private var mUserList = ArrayList<ChildrenItem>()
    ...
    private fun setViewModel() {
        ...
        viewModel.getUsersList().observe(activity!!, Observer {
            mUserList.clear()
            mUserList.addAll(it.data?.children!!)
            SetResetView()
            initAdapter()
        })
    }
